...
export default function Profile() {
  ...
  const downloadSingleLeaveReport = () => {
    ...
    logoImg.onload = () => {
      ...
      // Add report title
      doc.text(
        username + "'s \n Profile details Report on " + formatDate(new Date()),
        105,
        70,
        "center"
      );
        ...
        >
          <Form>
            <Grid container sx={{ paddingTop: "10px" }} spacing={2}>
              ...
              <Grid item xs={3}>
                <TextField name="etfNo" label="etfNo" value={etfNo} />
              </Grid>

              <Grid item xs={3}>
                <TextField name="epfNo" label="epfNo" value={epfNo} />
              </Grid>
              ...
              <Grid item xs={6}>
                <TextField name="nic" label="NIC" value={nic} />
              </Grid>
