...
export default function Home() {
  ...
  return (
    <div>
      {/* <p className="homeTitle">Welcome, Heshani!</p>
      ...
      >
                ...
                <CardContent>
                  <div className="d-flex flex-row align-items-start justify-content-between">
                    <div>
                      ...
                      <p className="homeTopic">Performance</p>
                    </div>
                    <div
                      className="homeIcons"
                  ...
                  {loading ? (
                    ...
                    <div>
                      <div className="d-flex align-items-end">
                        <p className="homeCountTop me-1">{data.performance}</p>
                      </div>
                      <p className="countDesc">
              ...
              >
                <CardContent>
                  <div className="d-flex flex-row align-items-start justify-content-between">
                    <div>
                      <p className="homeTopic">Your</p>
                      <p className="homeTopic">Notices</p>
                    </div>
                    <div
                      className="homeIcons"
                  ...
                  {loading ? (
                    ...
                    <div>
                      <div className="d-flex align-items-end">
                        <p className="homeCountTop me-1">{data.noticeCount}</p>
                      </div>
                      <p className="countDesc"> 0 Unread</p>
                    </div>
                  )}
                </CardContent>
              </CardActionArea>
        ...
        <Grid container item xs={12} spacing={3}>
          <Grid item xs={7}>
            <DashboardCard style={{ height: "100%" }}>
              <p className="homeTopic ms-3 mt-3">Top 7 Employees</p>
