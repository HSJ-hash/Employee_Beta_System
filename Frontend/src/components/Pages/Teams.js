...
export default function Teams() {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8070/team/getReport2")
      .then((res) => {
  ...
  const downloadPdf = () => {
    ...
    const headers = [
      ["Team Name", "Projects", "Project Count", "Members", "Member Count"],
    ];
    const document = teamData.map((Document) => [
      Document.team,
      Document.projects,
                ...
                <CardActionArea>
                  <CardContent>
                    ...
                    <p className="teamsSubData mt-0 d-flex">
                      Members
                      <p className="teamsSubData ms-3">
                        {row.memberDetails.length}
                      </p>
                    </p>
                    <p className="teamsSubData mt-0 d-flex">
                      Scores
                      <p className="teamsSubData ms-4 ps-2">{row.score}</p>
                    </p>
