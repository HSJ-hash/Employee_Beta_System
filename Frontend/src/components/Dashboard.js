...
import ViewProfile from "./PageComponents/ViewProfile";
import Notification from "./DispayComponents/Notification";
import ViewTeam from "./PageComponents/ViewTeam";
import ViewVacancy from "./PageComponents/ViewVacancy";
...
import EditVacancy from "./PageComponents/EditVacancy";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (sessionStorage.getItem("noticeAdded") == "1") {
      setNotify({
        isOpen: true,
        message: "Notice Created",
        type: "success",
      });
      sessionStorage.removeItem("noticeAdded");
      navigate("/documents");
    }
    ...
    if (sessionStorage.getItem("vacancyDeleted") == "1") {
      setNotify({
        isOpen: true,
        message: "Vacancy Deleted",
        type: "success",
      });
      sessionStorage.removeItem("vacancyDeleted");
    }
    ...
    if (sessionStorage.getItem("vacancyCreated") == "1") {
      setNotify({
        isOpen: true,
        message: "Vacancy Addeed",
        type: "success",
      });
      sessionStorage.removeItem("vacancyCreated");
    }
    ...
    if (sessionStorage.getItem("noticeUpdated") == "1") {
      setNotify({
        isOpen: true,
        message: "Notice Updated",
        type: "success",
      });
      sessionStorage.removeItem("noticeUpdated");
    }
