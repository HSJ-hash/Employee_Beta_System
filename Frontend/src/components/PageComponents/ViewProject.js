...
import VacancyViewTabbed from "./VacancyViewTabbed";
...
export default function ViewProject() {
  ...
  const inProgressTasks = taskList.filter(
    (task) => task.stage === "InProgress"
  ).length;
  const queueTasks = taskList.filter(
    (task) => task.stage === "NotStarted"
  ).length;
                  ...
                  <DashboardCard>
                    <CardContent>
                      <div className="d-flex flex-column align-items-start">
                        ...
                        <p className="countView">{completedTasks}</p>
                      </div>
                    </CardContent>
                  </DashboardCard>
                </Grid>
                  ...
                  <DashboardCard>
                    <CardContent>
                      <div className="d-flex flex-column align-items-start">
                        ...
                        <p className="countView">{inProgressTasks}</p>
                      </div>
                    </CardContent>
                  </DashboardCard>
                </Grid>
                  ...
                  <DashboardCard>
                    <CardContent>
                      <div className="d-flex flex-column align-items-start">
                        ...
                        <p className="countView">{queueTasks}</p>
                      </div>
                    </CardContent>
                  </DashboardCard>
                </Grid>
        ...
        <Grid xs={12} item className="mt-5 ">
          {loading ? (
            ...
            <DashboardCard className="pt-2">
              <VacancyViewTabbed projectId={projectId} role={role} />
            </DashboardCard>
          )}
        </Grid>
